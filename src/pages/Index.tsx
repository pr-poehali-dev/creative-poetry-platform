            ...
            <section className="py-24 px-6">
              <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-6" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.15rem", fontWeight: 300, lineHeight: 1.95, color: "rgba(240,232,213,0.72)" }}>
                  ...
                  <p>В жизни каждого человека встречаются радости и трудности, но во всём этом присутствует Господь. Надеемся, что читая строки здесь, вы сможете найти утешение, почувствовать Божью любовь, мир и тепло. Возможно, в каких-то стихах вы узнаете себя, свои переживания, и это послужит вам поддержкой.</p>
                  ...
                  <p>Мы приглашаем и вас стать частью нашего творческого пространства. Если у вас есть желание, вы можете делиться своими христианскими стихотворениями или теми, которые вам особенно близки. Будем вместе назидать друг друга!</p>
