          ...
          <div>
            <section className="relative min-h-screen flex flex-col items-center justify-center text-center px-6" style={{ background: "radial-gradient(ellipse at center, rgba(165,124,66,0.05) 0%, transparent 70%)" }}>
              ...
              <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.2rem", fontWeight: 300, lineHeight: 1.9, color: "rgba(58,45,32,0.93)", fontStyle: "italic", maxWidth: "560px" }}>
                Слова, рождённые из молитвы и тишины.<br />Каждое{"\u00A0"}стихотворение{"\u00A0"}—<br />свидетельство веры и красоты Божьего мира.
              </p>
            ...
            <section className="py-24 px-6">
              <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-6" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.28rem", fontWeight: 400, lineHeight: 1.95, color: "#3a2d20", textAlign: "justify", textIndent: "2.2rem", hyphens: "auto" }}>
                  <p>Рады приветствовать вас на нашей странице, где каждый стих — это отклик души, пропитанный молитвой, тишиной и глубокими жизненными переживаниями. Здесь собрано написанное мной, а также произведения моей бабушки и моего папы.</p>

                  <p>Этот сайт создан как место поддержки, утешения и духовного укрепления. Надеемся, что каждый, кто зайдёт сюда, найдёт слова, которые коснутся его сердца.</p>

                  <p>Собрание будет пополняться. Мы верим, что каждая строка, подобно псалмам, наполнена особым значением: в неё вложена частичка души, искренняя молитва и размышление о Божьей любви и Его Промысле.</p>

                  <p>В жизни каждого человека встречаются радости и трудности, но во всём этом присутствует Господь. Пусть чтение подарит вам утешение, ощущение Божьей любви, мира и тепла. Возможно, в чём-то вы узнаете себя и свои переживания, и это послужит поддержкой. Мы также храним ту часть семейного наследия, где поэзия становилась личным письмом: многое изначально предназначалось конкретным людям и остаётся тихим напоминанием о связи сердец.</p>
