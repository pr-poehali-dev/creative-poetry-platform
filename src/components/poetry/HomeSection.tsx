            ...
            <section className="py-24 px-6">
              <div className="max-w-3xl mx-auto">
                ...
                <div className="space-y-6" style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: "1.28rem", fontWeight: 400, lineHeight: 1.95, color: "#3a2d20", textAlign: "justify", textIndent: "2.2rem", hyphens: "auto" }}>
                  <p>Рады приветствовать вас на нашей странице. Здесь собрано написанное мной, а также произведения моей бабушки и моего папы.</p>

                  <p>Каждый стих — отклик души, рождённый в молитве и тишине. Мы верим, что такие строки, подобно псалмам, несут в себе особое значение.</p>

                  <p>Этот сайт создан как место поддержки и духовного укрепления. Надеемся, что каждый, кто зайдёт сюда, найдёт слова, которые коснутся его сердца.</p>

                  <p>Мы храним и ту часть семейного наследия, где поэзия становилась личным письмом: многое изначально предназначалось конкретным людям и остаётся тихим напоминанием о связи сердец. Собрание будет пополняться.</p>

                  <p>В жизни встречаются и радости, и трудности, но во всём этом присутствует Господь. Пусть чтение подарит вам утешение и ощущение Его любви. Возможно, в чём-то вы узнаете себя — и это станет вам опорой.</p>
